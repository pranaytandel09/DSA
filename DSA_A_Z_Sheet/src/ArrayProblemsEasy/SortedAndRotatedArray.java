...
public class SortedAndRotatedArray {
	 ...
	 * length such that B[i] == A[(i+x) % A.length] for every valid index i. xample
	 * 1:
	 * 
	 * Input: nums = [3,4,5,1,2] Output: true Explanation: [1,2,3,4,5] is the
	 * original sorted array. You can rotate the array by x = 2 positions to begin
	 * on the element of value 3: [3,4,5,1,2]. Example 2:
	 * 
	 * Input: nums = [2,1,3,4] Output: false Explanation: There is no sorted array
	 * once rotated that can make nums.
	 */
